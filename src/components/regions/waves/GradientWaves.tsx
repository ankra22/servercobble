...
/**
 * Vendorizado a partir do registry do react-bits (@react-bits/GradientWaves-JS-CSS),
 * portado pra TypeScript. Lógica mantida como no original — shader WebGL2 via
 * `ogl` (raymarching), uma instância só. Já pausa sozinho quando sai da tela
 * (IntersectionObserver) ou a aba perde foco (visibilitychange).
...
function detailToSteps(detail: Detail): number {
