...
/**
 * Vendorizado a partir do registry do react-bits (@react-bits/Radar-JS-CSS),
 * portado pra TypeScript. Lógica mantida como no original — shader WebGL via
 * `ogl`, uma instância só (não usar repetido numa lista, ao contrário do
 * Cubes). https://reactbits.dev/animations/radar
 */
...
export function Radar({
  ...
  return <div ref={containerRef} className={`radar-container ${className}`} />;
}
