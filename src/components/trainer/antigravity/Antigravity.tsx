...
/**
 * Vendorizado a partir do registry do react-bits (@react-bits/Antigravity-JS-CSS),
 * portado pra TypeScript. Lógica mantida como no original — campo de
 * partículas 3D via react-three-fiber/three, repelidas do cursor.
